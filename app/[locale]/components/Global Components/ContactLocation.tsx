...
const ContactLocation = ({ icon, white, underline }: ContactLocationProps) => {
  const t = useI18n();
  ...
  return icon ? (
    ...
    >
      {white && <img src="/icons/location-icon-white.svg" alt="" width={16} />}
      {!white && <img src="/icons/location-icon.svg" alt="" width={16} />}
      <span

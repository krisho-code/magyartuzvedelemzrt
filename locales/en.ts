export default {
  mainHero: {
    title: "Professional Fire Safety Solutions from Experts",
    description:
      "Our specialists provide modern, reliable solutions for a safer tomorrow.",
    cta1: "Get in Touch with Us!",
    cta2: "Check Out Our Services!",
  },
  homeAbout: {
    pageName: "About Us",
    title: "Why Choose Us?",
    cta: "Learn About Our Company!",
    info1: {
    ...
    info2: {
      ...
      description:
        "Our more than three decades of experience ensures reliable and professional execution in every project.",
    },
    info3: {
      title: "Comprehensive Services",
      description:
        "Passive fire protection, asbestos removal, fire and water damage restoration, industrial cleaning and alpine technology – everything in one place.",
    },
    info4: {
      title: "High Standards",
      description:
        "With certified technologies and an expert team, we guarantee the highest level of safety and efficiency.",
    },
  },
  homeServices: {
    pageName: "Services",
    ...
    services: {
      ...
      alpintechnika: "Industrial Alpine Technology",
    },
  },
  homeReferences: {
    pageName: "References",
    ...
    description:
      "Our references prove our professional commitment and reliability, with numerous successfully completed projects demonstrating the quality of our work.",
    projects: {
      veritas: "Veritas Tower",
      alfaplast: "AlfaPlast Industrial Site",
      dunapark: "DunaPark Condominiums",
    },
  },
  callToAction: {
    defaultTitle: "Safety for the Future – Choose Us!",
    defaultDescription:
      "Explore and learn about our services, then request a consultation or send us a quote request!",
    defaultCta1: "Learn About Our Services!",
    defaultCta2: "Request a Consultation!",
  },
  contactForm: {
    pageName: "Contact",
    title: "Get in Touch with Us!",
    description: "Contact us using the details below or send us a message!",
    contactInfo: {
    ...
    messages: {
      ...
      serverError: "A server error occurred while sending the message",
    },
  },
  header: {
    topbar: {
  ...
  footer: {
    ...
    links: {
      impresszum: "Imprint",
      adatkezelesitajekoztato: "Data Privacy Policy",
    },
  },
  aboutPage: {
    hero: {
